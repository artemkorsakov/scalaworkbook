...
Пакет `scala.compiletime` содержит вспомогательные определения, 
обеспечивающие поддержку операций над значениями во время компиляции. 
Они описаны ниже.
